...
$againTo = "<br/><hr><a href=/Admon/AgrTrabajador.php?IdEmpresa={$_GET['IdEmpresa']}>Volver a intentarlo.</a>";
...
<body>
    ...
    <section class="cuerpo">
        <div class="container">
            <form class="form-datos" action="<?php echo "./FncDatabase/TrabajadorAgregar.php?id=$IdEmpresa"; ?>" method="POST" role="form">
