  ...
  <body>
      ...
      <section class="jumbotron">
        ...
        if(!$con)
        {
            ...
            $consulta = "SELECT p.Nombre as NombreP,a.Nombre,p.Descripcion,p.Duracion FROM proyecto as p LEFT JOIN area as a ON p.id_Area=a.id_Area  where p.id_Area =".$row[0]." ;";
